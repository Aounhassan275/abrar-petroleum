    ...
    <table class="table datatable-save-state">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form action="{{route('supplier.bank_account.destroy',$account->id)}}" method="POST">
                        @method('DELETE')
                        @csrf
...
@include('supplier.bank_account.partials.add-account-modal')
@include('supplier.bank_account.partials.edit-account-modal')
...
<script>
    ...
    $('.edit-account-btn').click(function(){
            ...
            $('#updateFormForAccount').attr('action','{{route('supplier.bank_account.update','')}}' +'/'+id);
        });
</script>
@endsection