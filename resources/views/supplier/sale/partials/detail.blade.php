<div class="row">
    ...
    <div class="col-sm-3 col-xl-3">
        <div class="card card-body bg-blue-400 has-bg-image">
            <div class="media">
                ...
                <h3 class="mb-0">{{App\Models\Product::where('name','PMG')->first()->supplierAvailableStock()}}</h3>
        ...
        <div class="card card-body bg-success-400 has-bg-image">
            <div class="media">
                <div class="media-body align-self-center ">
                    <h3 class="mb-0">{{App\Models\Product::where('name','HSD')->first()->supplierAvailableStock()}}</h3>
    ...
    <div class="col-sm-3 col-xl-3">
        <div class="card card-body bg-violet-400 has-bg-image">
            <div class="media">
                <div class="media-body align-self-center ">
                    <h3 class="mb-0">{{App\Models\Product::where('name','PMG')->first()->supplierTotalSales()}}</h3>
    ...
    <div class="col-sm-3 col-xl-3">
        <div class="card card-body bg-warning-400 has-bg-image">
            <div class="media">
                ...
                <div class="media-body text-right">
                    <h3 class="mb-0">{{App\Models\Product::where('name','HSD')->first()->supplierTotalSales()}}</h3>
