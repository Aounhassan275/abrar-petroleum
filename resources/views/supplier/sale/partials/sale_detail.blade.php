    ...
    <table class="table datatable-save-state">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td id="cummulative_sale_amount_diesel">{{$diesel->totalCommulativeSaleAmount($date)}}</td>
            ...
            <tr>
                ...
                <td id="cummulative_sale_amount_petrol">
            ...
            <tr>
                ...
                <td id="test_sale_quantity_{{$misc_product_index}}">{{$misc_product->totalTestSale($date)}}</td>
                <td>0</td>
                <td> 
                ...
                <td id="cummulative_sale_amount_{{$misc_product_index}}">{{$misc_product->totalCommulativeSaleAmount($date)}}</td>
