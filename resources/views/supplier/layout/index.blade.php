...
<head>
	...
	<title>SUPPLIER PANEL | {{App\Models\Information::name()}}</title>
	@yield('styles')
	<!-- Global stylesheets -->
	...
	<div class="navbar navbar-expand-md navbar-dark">
		<div class="navbar-brand">
			<a href="{{url('/')}}" class="text-light">
				<h3 class="m-0"><b>Supplier Panel Menu</b></h3>
			</a>
		</div>
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown dropdown-user">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<a href="{{route('supplier.logout')}}" class="dropdown-item"><i class="icon-switch2"></i> Logout</a>
					</div>
				</li>
			</ul>
		</div>
			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							<a href="{{route('supplier.dashboard.index')}}" class="nav-link {{Request::is('supplier/dashboard')?'active':''}}">
						...
						<li class="nav-item">
							<a href="{{route('supplier.vehicle.index')}}" class="nav-link {{Request::is('supplier/vehicle') ?'active':''}}">
								<i class="icon-home4"></i>
								<span>Vehicle</span>
							</a>
						</li>
